...
import 'package:todolistfirebase/src/features/user/data/datasources/user_datasource.dart'
    as _i47;
import 'package:todolistfirebase/src/features/user/data/repositories/user_repository_impl.dart'
    as _i185;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i47.UserDataSource>(() => _i47.UserDataSource(
          gh<_i974.FirebaseFirestore>(),
          gh<_i688.AuthDataSource>(),
        ));
    ...
    gh.lazySingleton<_i961.AuthRepository>(
        () => _i545.AuthRepositoryImpl(gh<_i688.AuthDataSource>()));
    ...
    gh.lazySingleton<_i1016.UserRepository>(
        () => _i185.UserRepositoryImpl(gh<_i47.UserDataSource>()));
    gh.factory<_i237.GetUserUseCase>(
        () => _i237.GetUserUseCase(gh<_i1016.UserRepository>()));
    gh.factory<_i136.SaveUserUseCase>(
        () => _i136.SaveUserUseCase(gh<_i1016.UserRepository>()));
    gh.factory<_i844.UserBloc>(() => _i844.UserBloc(
          gh<_i136.SaveUserUseCase>(),
          gh<_i237.GetUserUseCase>(),
        ));
    return this;
  }
}
